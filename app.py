...
Ownership: RentIntel, including all source code, design, features, branding, logos, content, and documentation, is the property of Jacob W. Klingman and is protected by copyright, trademark, and other applicable laws.

Trademark Claim: “RentIntel” is a claimed trademark of Jacob W. Klingman. Unauthorized use of the name, logo, or branding in connection with any product, service, or software is prohibited.

License Reference: Use of the RentIntel source code is additionally governed by the Custom License located in the official RentIntel repository.

3. No Commercial Use Without Permission
You may not use RentIntel, in whole or in part, for any commercial purpose without prior written consent from the owner.

You may not clone, replicate, or create derivative works of RentIntel’s software, UI, or underlying logic for distribution, resale, or monetization.
...
7. Deal Projections and Reports
...
6. Data Deletion
If you wish to delete your stored deals or data, please contact: smart-rental-analyzer@outlook.com
